          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-12 lg:col-span-5">
              <div className="relative group">
                ...
                <div className="relative p-8 rounded-2xl border border-border/50 bg-gradient-to-br from-card/80 via-card/50 to-card/30 backdrop-blur-xl overflow-hidden">
                  <div className="absolute top-0 right-0 w-64 h-64 bg-accent/5 rounded-full blur-3xl" />
                  <div className="relative">
                    <div className="flex items-center gap-3 mb-6">
                      <div className="p-3 rounded-xl bg-gradient-to-br from-accent/20 to-accent/5 border border-accent/20 shadow-lg shadow-accent/10">
            ...
            <div className="col-span-12 lg:col-span-7">
              <div className="grid grid-cols-2 gap-4 h-full">
                <div className="p-6 rounded-2xl border border-border/50 bg-gradient-to-br from-card/60 to-card/30 backdrop-blur-xl hover:shadow-2xl hover:shadow-accent/5 transition-all duration-300 group">
                ...
                <div className="col-span-2 p-6 rounded-2xl border border-border/50 bg-gradient-to-br from-card/60 to-card/30 backdrop-blur-xl hover:shadow-2xl hover:shadow-accent/5 transition-all duration-300">
